...
In particular, the coefficient $1/8$ proposed in the preceding finite study is false.
...
given in the supplementary material; the main variational characterization does
...
Practical solvers may instead find solutions for subsequent exact verification.
...
The word count is exponential in $r$. No efficient high-precision
algorithm or closed-form constant follows. The supplementary implementation
uses SciPy to find sparse primal and dual solutions; exact rational
...
zero blocks and length-two identities. The lower bound on $m$ keeps the final
...
For the explicit four-block construction, let $x_*$ be the unique minimizer
on $[0,1]$ of
\[
 E(x)=\int_0^x\!\left[
...
For the width optimum, $G'<0$ and rational endpoint bounds isolate its zero.
...
them as an eventual finite separation condition. The uniform finite error bounds for this
...
\bibitem{blocks} M. Falconi, Supplementary proofs on alternating halves and
reflected blocks (2026):
\href{https://github.com/falker47/ringmin/blob/3beb8d70c5b3748d370a92855847bdf574e5a14f/research/PERMUTED_ALTERNATING_HALVES.md}{alternating-half feasibility}, Sections 1--6;
\href{https://github.com/falker47/ringmin/blob/3beb8d70c5b3748d370a92855847bdf574e5a14f/research/PERMUTED_HALVES_GENERAL_BLOCK_TRANSFER.md}{general block transfer};
\href{https://github.com/falker47/ringmin/blob/3beb8d70c5b3748d370a92855847bdf574e5a14f/research/PERMUTED_HALVES_FOURTH_ADJACENT_BLOCK.md}{the fourth adjacent block}.
Part of the versioned supplement \cite{supplement}.
\bibitem{upperinputs} M. Falconi, Supplementary proofs for the upper-endpoint
parameters (2026):
\href{https://github.com/falker47/ringmin/blob/3beb8d70c5b3748d370a92855847bdf574e5a14f/research/PERMUTED_HALVES_REFLECTED_PREFIX_LAMBDA.md}{reflected-prefix length}, Sections 2--7;
\href{https://github.com/falker47/ringmin/blob/3beb8d70c5b3748d370a92855847bdf574e5a14f/research/PERMUTED_HALVES_REFLECTED_PREFIX_ALPHA_MINIMUM.md}{shift minimum}, Sections 1, 3--4;
\href{https://github.com/falker47/ringmin/blob/3beb8d70c5b3748d370a92855847bdf574e5a14f/research/PERMUTED_HALVES_SECOND_BLOCK_BOUNDARY_MINIMUM.md}{second-block minimum};
\href{https://github.com/falker47/ringmin/blob/3beb8d70c5b3748d370a92855847bdf574e5a14f/research/PERMUTED_HALVES_THIRD_BLOCK_MIXED_WIDTH.md}{third-block mixed width}.
Part of the versioned supplement \cite{supplement}.
\bibitem{lower} M. Falconi, Supplementary proofs for the lower endpoint (2026):
\href{https://github.com/falker47/ringmin/blob/3beb8d70c5b3748d370a92855847bdf574e5a14f/research/COMMON_CHAIN_QUANTITATIVE_STABILITY.md}{common-chain quantitative stability}, Sections 2--5, 11;
\href{https://github.com/falker47/ringmin/blob/3beb8d70c5b3748d370a92855847bdf574e5a14f/research/THREE_LEVEL_COMMON_CHAIN.md}{three-level common-chain bounds}, Sections 7, 9, 11--12.
Part of the versioned supplement \cite{supplement}.
...
\url{https://github.com/falker47/ringmin/tree/3beb8d70c5b3748d370a92855847bdf574e5a14f}.
Main variational proof:
\href{https://github.com/falker47/ringmin/blob/3beb8d70c5b3748d370a92855847bdf574e5a14f/research/GLOBAL_ASYMPTOTIC_VARIATIONAL_LIMIT.md}{Global asymptotic variational limit}.
\end{thebibliography}
\end{document}
