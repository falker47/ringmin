...
theorem therefore supplies a fixed minimizing cyclic order at every central
...
Related circle-packing work prescribes tangency structure. Mathews and
Zymaris~\cite{mathews-zymaris} generalize Descartes' circle theorem to
$n$-flowers, whose petals are tangent to the central circle and to their
cyclic neighbors. Collins and Stephenson~\cite{collins-stephenson} compute
circle packings realizing a specified pattern of tangencies. In Ringmin,
the outer radii are fixed, the cyclic order must be chosen, and full
pairwise non-overlap must be imposed without assuming tangency between
consecutive outer circles.
...
pinned, content-addressed Git commit
...
The commit's manifest identifies the preserved original files separately.
...
certificate and its verifier are available at the pinned, content-addressed
Git commit in Section~\ref{sec:repro}; this is not an archival repository
deposit. The proof of the selected seam theorem is included
...
\bibitem{mathews-zymaris}
Mathews, D.V., Zymaris, O.: Spinors and the Descartes circle theorem.
Journal of Geometry and Physics \textbf{212}, 105458 (2025).
\url{https://doi.org/10.1016/j.geomphys.2025.105458}
\bibitem{collins-stephenson}
Collins, C.R., Stephenson, K.: A circle packing algorithm.
Computational Geometry \textbf{25}, 233--256 (2003).
