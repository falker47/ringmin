...
\usepackage{lmodern}
\hypersetup{pdftitle={Minimum central circles: certified finite optima and an effective global asymptotic constant},
...
construction whose total slab length is strictly below $1-\alpha$, where
$0\le\alpha<1$ is the shift parameter, to genuine permutations and full ring
...
The repository supplement is fixed at commit
\texttt{3beb8d70c5b3748d370a92855847bdf574e5a14f} \cite{packet};
all supplementary paths below refer to that snapshot unless an earlier
checkpoint is explicitly specified. It contains complete mathematical proofs, exact
...
Repository: \url{https://github.com/falker47/ringmin}.
Supplementary snapshot:
\href{https://github.com/falker47/ringmin/tree/3beb8d70c5b3748d370a92855847bdf574e5a14f}{repository at the reviewed commit}.
Internal validation
